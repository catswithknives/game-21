	...
	private void initialize() {
		...
		btnDraw.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				lblNewLabel.setText(Integer.toString(p.getCard(1)));
				lblNewLabel_2.setText(Integer.toString(p.getCard(2)));
				lblNewLabel_1.setText(Integer.toString(d.getCard(1)));
				lblNewLabel_5.setText(Integer.toString(d.getCard(2)));
				
			if (d.getCard(1) + d.getCard(2) > 13)
				lblNewLabel_6.setText(Integer.toString(d.getCard(3)));
		...
		btnDrawAgain.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				lblNewLabel_3.setText(Integer.toString(p.getCard(3)));
